-- 1. Load Parquet Extension
INSTALL parquet;
LOAD parquet;

-- 2. Cleanup existing tables to avoid conflicts
...
-- 3. Create Tables with EXACT Schema from your test file
-- (This ensures DECIMALS remain DECIMALS and DATES remain DATES)
...
-- 4. Load Data from YOUR specific .tbl files
...
-- 5. Export to Parquet (This ensures the parquet file contains the EXACT data from step 4)
COPY nation TO 'test_datasets/tpch-dbgen-parquet/nation.parquet' (FORMAT 'PARQUET');
COPY region TO 'test_datasets/tpch-dbgen-parquet/region.parquet' (FORMAT 'PARQUET');
COPY part TO 'test_datasets/tpch-dbgen-parquet/part.parquet' (FORMAT 'PARQUET');
COPY supplier TO 'test_datasets/tpch-dbgen-parquet/supplier.parquet' (FORMAT 'PARQUET');
COPY partsupp TO 'test_datasets/tpch-dbgen-parquet/partsupp.parquet' (FORMAT 'PARQUET');
COPY customer TO 'test_datasets/tpch-dbgen-parquet/customer.parquet' (FORMAT 'PARQUET');
COPY orders TO 'test_datasets/tpch-dbgen-parquet/orders.parquet' (FORMAT 'PARQUET');
COPY lineitem TO 'test_datasets/tpch-dbgen-parquet/lineitem.parquet' (FORMAT 'PARQUET');