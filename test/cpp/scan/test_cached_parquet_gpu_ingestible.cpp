...
// Unit tests for cached_parquet_gpu_ingestible constructor-argument
...
TEST_CASE("cached_parquet_gpu_ingestible - GPU ctor rejects mismatched chunk counts",
          "[scan][cached_parquet_gpu_ingestible]")
{
  ...
  REQUIRE_THROWS_AS(sscan::cached_parquet_gpu_ingestible(empty_parquet_table_info(),
                                                         std::move(columns),
...
TEST_CASE("cached_parquet_gpu_ingestible - GPU ctor with no chunks has no work",
          "[scan][cached_parquet_gpu_ingestible]")
{
  ...
  sscan::cached_parquet_gpu_ingestible ingestible(empty_parquet_table_info(),
                                                  /*columns_per_request=*/{},
                                                  /*chunk_memory_spaces=*/{},
                                                  /*filter_expression=*/nullptr,
                                                  empty_plan());
