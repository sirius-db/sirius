...
// The recognizer derives L2SqrtUnexpanded for array_distance
// (vss_pattern.cpp::metric_for_function), while a 'l2sq' index is built
// L2SqrtExpanded (ann_distance_type_from_metric). find_by_column must fold the two
// or a query would never match its own pinned index.
