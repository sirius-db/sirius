...
TEST_CASE("inspectable_mpsc get_if front_to_back finds without removing", "[inspectable_mpsc]")
{
  ...
  auto* ptr = queue.get_if([](const int& v) { return v == 30; }, true);
  REQUIRE(ptr != nullptr);
  REQUIRE(*ptr == 30);
  REQUIRE(queue.size() == 5);
}
...
TEST_CASE("inspectable_mpsc get_if back_to_front finds without removing", "[inspectable_mpsc]")
{
  ...
  auto* ptr = queue.get_if([](const int& v) { return v == 30; }, false);
  REQUIRE(ptr != nullptr);
  REQUIRE(*ptr == 30);
  REQUIRE(queue.size() == 5);
}
...
TEST_CASE("inspectable_mpsc get_if front_to_back returns first of duplicates", "[inspectable_mpsc]")
{
  ...
  // get_if should find the first 20
  auto* ptr = queue.get_if([](const int& v) { return v == 20; }, true);
  REQUIRE(ptr != nullptr);
  REQUIRE(*ptr == 20);
  ...
  auto* ptr2 = queue.get_if([](const int& v) { return v == 20; }, true);
  REQUIRE(ptr2 != nullptr);
  REQUIRE(*ptr2 == 20);

  // Queue is now [10, 30, 20, 50]
  REQUIRE(queue.size() == 4);
}
...
TEST_CASE("inspectable_mpsc get_if back_to_front returns last of duplicates", "[inspectable_mpsc]")
{
  ...
  // get_if back-to-front should find the second 20
  auto* ptr = queue.get_if([](const int& v) { return v == 20; }, false);
  REQUIRE(ptr != nullptr);
  REQUIRE(*ptr == 20);
...
TEST_CASE("inspectable_mpsc get_if no match returns nullptr", "[inspectable_mpsc]")
{
  ...
  auto* ptr = queue.get_if([](const int& v) { return v == 99; }, true);
  REQUIRE(ptr == nullptr);
  REQUIRE(queue.size() == 3);
}
