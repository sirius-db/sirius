                                          ...
                                          ::cuda::stream_ref stream)
{
  ...
  stream.sync();  // callers pass temporaries; these tests do not benchmark ingestion
  return col;
}
...
rmm::device_buffer upload_prior_mask(std::vector<bool> const& keep, ::cuda::stream_ref stream)
{
...
void attach_validity(cudf::column& col, std::vector<bool> const& valid, ::cuda::stream_ref stream)
{
...
std::unique_ptr<cudf::scalar> make_day_scalar(std::int32_t day, ::cuda::stream_ref stream)
{
