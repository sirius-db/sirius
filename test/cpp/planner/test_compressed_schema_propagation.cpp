...
/// per column, or empty for native).
...
TEST_CASE("compressed_schema_propagation - dynamic-filter scan sidecar is cleared",
          "[compressed_schema_propagation]")
{
  SECTION("a scan with wired producers is marked native")
  {
