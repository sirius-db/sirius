...
|---|---|---|---|
| `socket` *(default)* | `0-71 / 0-71 / 72-143 / 72-143` | 288 (2× over) | what OPEN-ISSUES M1 specifies; two CNs per socket may borrow each other's idle cores |
...
### Host — and the OPEN-ISSUES M1 item 3 conflict, resolved
