...
nohup env SCALE_FACTOR="$SCALE_FACTOR" ./configs/gb200-8gpu/launch.sh "$FE_HOST" "$FE_HOST" \
...
nohup env SCALE_FACTOR=$(printf %q "$SCALE_FACTOR") ./configs/gb200-8gpu/launch.sh \
