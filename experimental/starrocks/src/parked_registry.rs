...
//! claims that stream (relay or Arrow pull) and releases when done. The fragment — and the GPU
...
impl<F> ParkedRegistry<F> {
    ...
    /// The parked fragment and the stream a slot names, for relay and Arrow pull.
