...
///
/// Tunable via [`SIRIUS_CN_RPC_TIMEOUT_SECS`](crate::nixl_transport::rpc_timeout), and worth
/// tuning at scale. Read per dial rather than cached in the client: the resolved knob is one
/// atomic load, dials are rare, and reading through keeps a single source of truth.
fn reply_timeout() -> Duration {
    crate::nixl_transport::rpc_timeout()
}
