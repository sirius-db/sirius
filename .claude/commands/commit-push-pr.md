...
6. Determine the current branch. If on `dev`, create a new feature branch first (`git checkout -b <descriptive-name>`).
7. Push to remote with `git push -u origin <branch>`.
8. Create a PR against `dev` using `gh pr create` with:
