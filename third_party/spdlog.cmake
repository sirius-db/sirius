...
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
  set(SPDLOG_STATIC_LIB
      ${SPDLOG_LIB_DIR}/${CMAKE_STATIC_LIBRARY_PREFIX}spdlogd${CMAKE_STATIC_LIBRARY_SUFFIX}
  )
else()
  set(SPDLOG_STATIC_LIB
      ${SPDLOG_LIB_DIR}/${CMAKE_STATIC_LIBRARY_PREFIX}spdlog${CMAKE_STATIC_LIBRARY_SUFFIX}
  )
endif()
...
ExternalProject_Add(
  ...
  CMAKE_ARGS -DSPDLOG_BUILD_SHARED:BOOL=OFF
...
file(MAKE_DIRECTORY ${SPDLOG_INCLUDE_DIR}) # Include directory needs to exist to
                                           # run configure

add_library(spdlog::spdlog STATIC IMPORTED)
set_target_properties(spdlog::spdlog PROPERTIES IMPORTED_LOCATION
                                                ${SPDLOG_STATIC_LIB})
target_include_directories(spdlog::spdlog INTERFACE ${SPDLOG_INCLUDE_DIR})
add_dependencies(spdlog::spdlog ${SPDLOG_BASE})

# Default log directory
set(SIRIUS_DEFAULT_LOG_DIR "${CMAKE_BINARY_DIR}/log")
add_compile_definitions(SIRIUS_DEFAULT_LOG_DIR="${SIRIUS_DEFAULT_LOG_DIR}")
