...
- [ ] 22.1-05-PLAN.md — Migrate iceberg metadata + equality-delete reads (sites #3 + #4) to GPU 0 ioctx (single-GPU sufficient per D-06)
- [ ] 22.1-06-PLAN.md — Delete unit-test fallback at parquet_split_provider.cpp:295 (site #7); update test fixtures to inject ioctx
