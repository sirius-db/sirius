...
| 24. Update cucascade + sirius from upstream (round 2) | v1.5+ | 0/5 | Planned     | — |
...
Plans:
- [ ] 24-01-PLAN.md — Upstream cucascade diff triage (96bfea1 + 9ceebaa) + 24-CONFLICT-LOG.md skeleton + start cucascade rebase
- [ ] 24-02-PLAN.md — Complete cucascade rebase per D-01/D-02 (re-derive surviving fixes) + cucascade ctest + atomic sirius gitlink bump (D-04 Commit A)
