  ...
  duckdb::ClientContext& context) const
{
  ...
  // With no explicit label, fall back to the intercepted SQL text so transparently-executed
  // queries get a recognizable telemetry name instead of "unnamed_query".
