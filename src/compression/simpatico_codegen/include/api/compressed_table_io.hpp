...
//
// Splits the .hpln v8 stream into its two natural regions so the caller can keep
...
/// Build the .hpln v8 header for @p table into @p out_header and enumerate every
