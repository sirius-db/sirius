...
// 12: added the per-column validity sidecar record (see push_validity).
...
std::string hpln_stream_writer::append(compressed_table const& table, ::cuda::stream_ref stream)
{
