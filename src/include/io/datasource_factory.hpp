...
/// buffers.  Construction needs no live endpoint configuration; this factory
/// does not yet wire an RDMA client into the ioctx, so any S3 access through
/// the backend fails loudly.
