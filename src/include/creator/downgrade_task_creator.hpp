...
class downgrade_task_creator : public itask_creator {
 public:
   ...
   *
   * @param data_repo_mgr Reference to the data repository manager for accessing and storing data
   * batches
   * @param downgrade_exec Reference to the downgrade executor for task execution
   */
  downgrade_task_creator(cucascade::shared_data_repository_manager& data_repo_mgr,
