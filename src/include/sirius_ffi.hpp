...
class SIRIUS_FFI_EXPORT Context {
 public:
  ...
  /// Return the staging lease at `offset`. The block goes back to the arena's free list and
  /// coalesces with its free neighbours — leases are short-lived by design
  /// (copy-out-on-arrival).
