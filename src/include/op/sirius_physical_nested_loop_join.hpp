...
class sirius_physical_nested_loop_join : public sirius_physical_operator {
 public:
  static constexpr const duckdb::PhysicalOperatorType TYPE = duckdb::PhysicalOperatorType::NESTED_LOOP_JOIN;
 ...
 public:
  ...
  static bool is_supported(const duckdb::vector<duckdb::JoinCondition>& conditions, duckdb::JoinType join_type);
