...
class sirius_gpu_parquet_scan_operator : public sirius_physical_operator {
 public:
   ...
   *     filter expression and post_filter_projection_ids carried on the split are
   *     applied to it. When neither is present the cached batch is forwarded unchanged.
   *
