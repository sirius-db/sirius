...
class owning_table_view {
 public:
   ...
   *
   * Reader events recorded through @ref record_reader_event are unaffected by the transfer:
   * they live on the owner's underlying batch, which awaits them before any mutable access and
   * on destruction.
   *
