...
=======
   ...
   * @note Thread-safe operation
   */
  void add_new_data_batch(sirius::unique_ptr<data_batch> batch,
...
>>>>>>> b0909dcf (made progress building out downgrading system, changed how we pass around memory spaces)
   ...
   * downgraded
   */
  std::vector<std::unique_ptr<data_batch>>
  get_data_batches_for_downgrade(sirius::memory::memory_space_id memory_space_id,
...
=======
  ...
  sirius::unordered_map<size_t, sirius::unique_ptr<idata_repository>>
    _repositories; ///< Map of pipeline ID to idata_repository
  unordered_map<size_t, sirius::unique_ptr<data_batch>> _data_batches;
>>>>>>> b0909dcf (made progress building out downgrading system, changed how we pass around memory spaces)
};
