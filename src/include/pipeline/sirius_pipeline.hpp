 ...
 */
 ...
 class sirius_pipeline_build_state {
  ...
  public:
   ...
   duckdb::reference_map_t<const op::sirius_physical_operator, duckdb::reference<sirius_pipeline>> delim_join_dependencies;
   //! Materialized CTE scan dependencies
   duckdb::reference_map_t<const op::sirius_physical_operator, duckdb::reference<sirius_pipeline>> cte_dependencies;
  ...
  public:
   ...
   void set_pipeline_operators(sirius_pipeline& pipeline,
   ...
   duckdb::vector<duckdb::reference<op::sirius_physical_operator>> get_pipeline_operators(sirius_pipeline& pipeline);
 };
