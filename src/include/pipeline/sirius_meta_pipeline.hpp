 ...
 */
 ...
 class sirius_meta_pipeline : public duckdb::enable_shared_from_this<sirius_meta_pipeline> {
  ...
  public:
   ...
   void get_meta_pipelines(duckdb::vector<duckdb::shared_ptr<sirius_meta_pipeline>>& result, bool recursive, bool skip);
   //! Get the dependencies (within this sirius_meta_pipeline) of the given Pipeline
   duckdb::optional_ptr<const duckdb::vector<duckdb::reference<sirius_pipeline>>> get_dependencies(sirius_pipeline& dependent) const;
  ...
  public:
   ...
   sirius_meta_pipeline& create_child_meta_pipeline(sirius_pipeline& current, op::sirius_physical_operator& op);
  ...
  private:
   ...
   duckdb::reference_map_t<sirius_pipeline, duckdb::vector<duckdb::reference<sirius_pipeline>>> dependencies;
