...
sirius_physical_plan_generator::create_plan(duckdb::LogicalDelimGet& op)
{
  ...
  auto chunk_scan = duckdb::make_uniq<sirius::op::sirius_physical_column_data_scan>(
    op.types, sirius::op::SiriusPhysicalOperatorType::DELIM_SCAN, op.estimated_cardinality, nullptr);
