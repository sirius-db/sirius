...
{
  SIRIUS_LOG_INFO(
    "[sirius_plan_get] create_plan for LogicalGet: function={}, bind_data={}, column_ids={}",
    op.function.name,
    (op.bind_data ? "present" : "NULL"),
  ...
  SIRIUS_LOG_INFO("[sirius_plan_get] dependency fn={}, bind_data={}",
                  op.function.dependency ? "present" : "NULL",
                  op.bind_data ? "present" : "NULL");
