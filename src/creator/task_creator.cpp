...
void itask_creator::start() {
    ...
    _thread = sirius::make_unique<parallel::task_executor_thread>(sirius::make_unique<sirius::thread>(&itask_creator::worker_loop, this));
}
...
uint64_t itask_creator::get_next_task_id() {
