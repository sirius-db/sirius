...
task_creation_queue::task_creation_queue(size_t num_threads) 
  : _num_threads(num_threads) {}

void task_creation_queue::open() { 
...
void task_creator::on_start() { 
  _task_creation_queue->open(); 
}

void task_creator::on_stop() {
  _task_creation_queue->close(); 
}
