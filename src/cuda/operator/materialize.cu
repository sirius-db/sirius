...
template <typename T>
void materializeExpression(const T *a, T* result, uint64_t *row_ids, uint64_t N) {
...
template
void materializeExpression<int>(const int *a, int* result, uint64_t *row_ids, uint64_t N);
template
void materializeExpression<uint64_t>(const uint64_t *a, uint64_t* result, uint64_t *row_ids, uint64_t N);
template
void materializeExpression<float>(const float *a, float* result, uint64_t *row_ids, uint64_t N);
template
void materializeExpression<double>(const double *a, double* result, uint64_t *row_ids, uint64_t N);
template
void materializeExpression<uint8_t>(const uint8_t *a, uint8_t* result, uint64_t *row_ids, uint64_t N);
