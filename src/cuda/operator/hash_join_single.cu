...
__global__ void probe_right_semi_anti_single(T** keys,
...
template <int B, int I, typename T>
__global__ void probe_single_match(T** keys,
                                   unsigned long long* ht,
                                   uint64_t ht_len,
...
template <int B, int I, typename T>
__global__ void probe_mark(T** keys,
                           unsigned long long* ht,
                           uint64_t ht_len,
                           uint8_t* output,
                           uint64_t N,
                                            ...
                                            int num_keys)
{
  ...
  int tile_items = BLOCK_THREADS * ITEMS_PER_THREAD;
  probe_right_semi_anti_single<BLOCK_THREADS, ITEMS_PER_THREAD, T>
                        ...
                        int num_keys)
{
  ...
  int tile_items = BLOCK_THREADS * ITEMS_PER_THREAD;
  CHECK_ERROR();
  probe_mark<BLOCK_THREADS, ITEMS_PER_THREAD, T>
    <<<(N + tile_items - 1) / tile_items, BLOCK_THREADS>>>(
      keys_dev, ht, ht_len, output, N, condition_mode_dev, num_keys, equal_keys);
  CHECK_ERROR();
  cudaDeviceSynchronize();
  STOP_TIMER();
...
template void probeHashTableSingleMatch<int32_t>(uint8_t** keys,
                                                 unsigned long long* ht,
                                                 uint64_t ht_len,
                                                 uint64_t*& row_ids_left,
                                                 uint64_t*& row_ids_right,
...
template void probeHashTableSingleMatch<int64_t>(uint8_t** keys,
                                                 unsigned long long* ht,
                                                 uint64_t ht_len,
                                                 uint64_t*& row_ids_left,
                                                 uint64_t*& row_ids_right,
...
template void probeHashTableRightSemiAntiSingleMatch<int32_t>(uint8_t** keys,
                                                              unsigned long long* ht,
                                                              uint64_t ht_len,
                                                              uint64_t N,
                                                              int* condition_mode,
...
template void probeHashTableRightSemiAntiSingleMatch<int64_t>(uint8_t** keys,
                                                              unsigned long long* ht,
                                                              uint64_t ht_len,
                                                              uint64_t N,
                                                              int* condition_mode,
...
template void probeHashTableMark<int32_t>(uint8_t** keys,
                                          unsigned long long* ht,
                                          uint64_t ht_len,
                                          uint8_t*& output,
                                          uint64_t N,
...
template void probeHashTableMark<int64_t>(uint8_t** keys,
                                          unsigned long long* ht,
                                          uint64_t ht_len,
                                          uint8_t*& output,
                                          uint64_t N,
