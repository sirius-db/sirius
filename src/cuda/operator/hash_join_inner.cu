...
__global__ void probe_multikey_count(T** keys,
...
template <int B, int I, typename T>
__global__ void probe_multikey(T** keys,
                               unsigned long long* ht,
                               uint64_t ht_len,
                               uint64_t* offset_each_thread,
...
template <int B, int I, typename T>
__global__ void build_multikey(T** keys,
                               unsigned long long* ht,
                               uint64_t ht_len,
                               uint64_t N,
                               int num_keys,
                    ...
                    bool is_right)
{
  ...
  build_multikey<BLOCK_THREADS, ITEMS_PER_THREAD, T>
                    ...
                    bool is_right)
{
  ...
  CHECK_ERROR();
  probe_multikey_count<BLOCK_THREADS, ITEMS_PER_THREAD, T>
...
template void buildHashTable<int32_t>(uint8_t** keys,
                                      unsigned long long* ht,
                                      uint64_t ht_len,
                                      uint64_t N,
                                      int* condition_mode,
...
template void buildHashTable<int64_t>(uint8_t** keys,
                                      unsigned long long* ht,
                                      uint64_t ht_len,
                                      uint64_t N,
                                      int* condition_mode,
...
template void probeHashTable<int32_t>(uint8_t** keys,
                                      unsigned long long* ht,
                                      uint64_t ht_len,
                                      uint64_t*& row_ids_left,
                                      uint64_t*& row_ids_right,
...
template void probeHashTable<int64_t>(uint8_t** keys,
                                      unsigned long long* ht,
                                      uint64_t ht_len,
                                      uint64_t*& row_ids_left,
                                      uint64_t*& row_ids_right,
