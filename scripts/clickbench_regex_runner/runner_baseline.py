...
def load_args():
    ...
    parser.add_argument("--caching_region_size", type=str, default= "39 GB", help="Size of the caching region.")
    parser.add_argument("--processing_region_size", type=str, default= "39 GB", help="Size of the processing region.")
...
def benchmark_query(args, query_to_run, query_label):
    ...
    with open(query_temp_file_path, 'w+') as writer:
        writer.write(f"set enable_regex_jit_impl=false;\n")
