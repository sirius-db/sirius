...
COPY lineitem FROM 'dbgen/s20/lineitem.tbl' WITH (HEADER false, DELIMITER '|');
COPY orders FROM 'dbgen/s20/orders.tbl' WITH (HEADER false, DELIMITER '|');
COPY supplier FROM 'dbgen/s20/supplier.tbl' WITH (HEADER false, DELIMITER '|');
COPY part FROM 'dbgen/s20/part.tbl' WITH (HEADER false, DELIMITER '|');
COPY customer FROM 'dbgen/s20/customer.tbl' WITH (HEADER false, DELIMITER '|');
COPY partsupp FROM 'dbgen/s20/partsupp.tbl' WITH (HEADER false, DELIMITER '|');
COPY nation FROM 'dbgen/s20/nation.tbl' WITH (HEADER false, DELIMITER '|');
COPY region FROM 'dbgen/s20/region.tbl' WITH (HEADER false, DELIMITER '|');
