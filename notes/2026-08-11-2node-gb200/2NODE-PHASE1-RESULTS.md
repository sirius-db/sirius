> **Historical.** Transport refusal (~0.4 GB/s) was fixed by
> `SIRIUS_EXCHANGE_STAGING_ARENA=fabric`. The working procedure is
> [`experimental/starrocks/benchmarks/2NODE-REPLICATE.md`](../../experimental/starrocks/benchmarks/2NODE-REPLICATE.md)
> (98 GB/s). Living queue: [`notes/OPEN.md`](../OPEN.md).
