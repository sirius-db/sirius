...
| [Dynamic Filters — Top-N](dynamic-filters-top-n.md) | Progressive Top-N threshold publication (implemented; measured at SF1000): layered RANGE/LEX_RANGE filters, versioned replacement, ordering semantics, scan/endpoint consumers, and measured results |
