...
| [Compressed Materialization](compressed-materialization.md) | Statistics-guided narrow integer and DECIMAL carriers, restoration boundaries, and pin-cache invariants |
