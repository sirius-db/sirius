...
> **Historical plan; actual delivery (2026-07-09):** Track A shipped delete-only in merged PR
...
> **Do not execute the staged instructions below.** They are retained only as the pre-decision
> design record; current Track C owns any telemetry/lifecycle work that the abandoned A1 described.
