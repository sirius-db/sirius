...
vcpkg_from_github(
    ...
    REF v26.02.00
    SHA512 36405e2cb907b84061789206e9c8dbea95bd0f68dd1762a4e8ca274933018b5c20637fb67be7b6f33109a2666edb2b5359a6b7c9e36bff08d63e5ba8f2a4e57f
    HEAD_REF main
)
...
# Patch kvikio to not require cuFile Batch/Stream API (may not be available in the CUDA toolkit).
# KvikIO still works without cuFile, just disables GPUDirect Storage (GDS).
vcpkg_replace_string("${SOURCE_PATH}/cpp/CMakeLists.txt"
    "if(NOT TARGET CUDA::cuFile)"
    "if(TRUE) # Disable cuFile/GDS - batch/stream API requires newer cuFile SDK"
)

# Add stub declarations for cuFile batch/stream API functions so the shim compiles
# without cufile.h. These are never called - they only provide type info for decltype().
vcpkg_replace_string("${SOURCE_PATH}/cpp/include/kvikio/shim/cufile_h_wrapper.hpp"
