...
string(JSON _sha512 GET "${_redistrib}" "${VCPKG_CUDA_VERSION}" "${_platform}"
       sha512)
string(JSON _component GET "${_redistrib}" "${VCPKG_CUDA_VERSION}" component)
set(_archive "${_component}-${_platform}-${_version}-archive.tar.xz")

vcpkg_download_distfile(
  ARCHIVE
  URLS
  "https://developer.download.nvidia.com/compute/cuda/redist/${_component}/${_platform}/${_archive}"
  FILENAME
  "${_archive}"
  SHA512
  "${_sha512}")
...
file(INSTALL "${SOURCE_PATH}/lib/libculibos.a"
